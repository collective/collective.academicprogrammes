...
ptc.setupPloneSite(products=['collective.academicprogrammes'])
...
def test_suite():
    return unittest.TestSuite([
        ...
        #    'README.txt', package='collective.academicprogrammes',
        #    setUp=testing.setUp, tearDown=testing.tearDown),

        #doctestunit.DocTestSuite(
        #    module='collective.academicprogrammes.mymodule',
        #    setUp=testing.setUp, tearDown=testing.tearDown),
